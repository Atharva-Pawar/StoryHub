...
import { BlogCard, BlogCardSkeleton, Appbar } from "../components";
...
const Blogs = () => {
  ...
  if (loading) {
    return (
      <>
        <Appbar />
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-4 pt-16">
          {[...Array(5)].map((_, i) => (
  ...
  if (error) {
    return (
      <>
        <Appbar />
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-16">
          <div className="text-center py-12">
            ...
            <h2 className="mt-4 text-xl font-semibold text-[var(--color-text-primary)]">Failed to load stories</h2>
